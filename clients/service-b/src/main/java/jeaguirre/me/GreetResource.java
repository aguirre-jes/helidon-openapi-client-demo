...
import io.helidon.examples.openapigen.mp.client.api.ApiException;
import io.helidon.examples.openapigen.mp.client.api.DefaultApi;
...
public class GreetResource {
    ...
    public io.helidon.examples.openapigen.mp.client.model.Message getDefaultMessage(@HeaderParam("x-api") String xApi)
            throws ProcessingException, ApiException {
        System.out.println("x-api: " + xApi);
        return defaultApi.greetGet();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RequestBody(name = "greeting", required = true, content = @Content(mediaType = "application/json", schema = @Schema(type = SchemaType.OBJECT, requiredProperties = {
            "greeting" })))
    @APIResponses({
